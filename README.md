...
| **Notifications** | Discord: online (with the address in direct-connect mode), Game ID (relay mode), offline, crashed, updating/updated, backup, join, leave. Plain text, every message overridable. |
...
| `MAX_PLAYERS` | `10` | |
| `GAME_PASSWORD` | — | Join password, direct-connect mode only. |
